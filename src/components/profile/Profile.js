  ...
  return (
    <div id="profile">
      ...
      <div className="contact-flex">
        <p className="contact-1"><b>contact:</b> brarjashan417@gmail.com</p>
        <p className="contact-1"><b>github</b>: <a href="https://github.com/JashanB">https://github.com/JashanB</a></p>
