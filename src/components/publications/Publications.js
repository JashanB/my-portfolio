  ...
  return (
    <div id="publications">
      ...
      <div className="publications-list">
        <h4>International Journal of Stroke (2016)</h4>
        <p>Technological Trends in Stroke Rehabilitation for Motor Function Recovery (Vol 11 Pg 68-68).</p>
        <h4>ACRM Annual Meeting Chicago / Archives of Physical Medicine and Rehabilitation (2016)</h4>
        <p>The efficacy of playing musical instruments for upper limb rehabilitation among individuals with stroke: A systematic review.</p>
        ...
        <p> Chapter 14: Aphasia and Apraxia. Evidence-Based Review of Stroke Rehabilitation. </p>
        <a href="http://ebrsr.com/evidence-review">http://ebrsr.com/evidence-review</a>
      </div>
    </div>
  )
}